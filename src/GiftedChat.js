...
class GiftedChat extends React.Component {
  ...
  calculateInputToolbarHeight() {
    return this.state.composerHeight + (this.getMinInputToolbarHeight() - MIN_COMPOSER_HEIGHT);
  }
  ...
  usingSpacer() {
    return Platform.OS === 'ios' || this.props.forceKeyboardSpacer;
  }
...
GiftedChat.propTypes = {
  ...
  forceKeyboardSpacer: PropTypes.bool,
};
